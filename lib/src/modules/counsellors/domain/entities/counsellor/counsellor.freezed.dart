    ...
    return _then(_value.copyWith(
      ...
      speciality: null == speciality
          ...
          : speciality // ignore: cast_nullable_to_non_nullable
              as String,
      yrsOfExperience: null == yrsOfExperience
...
class _$CounsellorImpl implements _Counsellor {
  const _$CounsellorImpl(
      ...
      required final List<int> workingHours})
...
abstract class _Counsellor implements Counsellor {
  const factory _Counsellor(
      ...
      required final List<int> workingDays,
      required final List<int> workingHours}) = _$CounsellorImpl;
